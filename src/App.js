...
function App() {
    ...
    const addTask = (task) => {
        ...
        Swal.fire({
            icon: 'success',
            title: 'Yay...',
            text: 'You have successfully added a new student!'
        })
    ...
    const deleteTask = (id) => {
        ...
        Swal.fire({
            icon: 'success',
            title: 'Oops...',
            text: 'You have successfully deleted a student!'
        })
    ...
    const editTask = (id) => {
        ...
        Swal.fire({
            icon: 'success',
            title: 'Yay...',
            text: 'You have successfully edited an existing student!'
        })
        ...
        <>
            {
                loading
                    ...
                    <div className="container">
                        ...
                        {/* Task Counter */}
                        <h3>Number of Students: {tasks.length}</h3>
